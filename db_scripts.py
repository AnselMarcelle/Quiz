...
def add_questions():
    questions = [
        ('В каком году была основана Америка?', '1492', '1500', '1499', '1490'),
        ('Какая самая высокая гора в мире?', 'Макалу', 'Эверест', 'Канченджанга', 'Чогори'),
        ('Сколько планет в Солнечной системе?', '8', '4', '9', '10'),
